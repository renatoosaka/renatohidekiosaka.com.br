    ...
    <div>
      ...
      <main className="flex justify-center items-center h-screen antialiased">
        <div className="flex flex-col justify-center items-center">
          ...
          <p className="dark:text-gray-400 mt-4 leading-6">Sou dev, invento umas paradas maneiras com Node.js ReactJS e React Native</p>
          <p className="dark:text-gray-400 leading-6">Ahh estou aprendendo Go, muito massinha!</p>
          <div className="flex flex-row mt-4">
            <Link href="https://github.com/renatoosaka/">
              <a className="dark:text-gray-400 ml-4 hover:text-gray-200 transition">
                <FaGithub size={20} />
              </a>
            </Link>
